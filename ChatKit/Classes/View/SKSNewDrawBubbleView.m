//
//  SKSNewDrawBubbleView.m
//  ChatKit
//
//  Created by iCrany on 2017/2/20.
//
//
...
@interface SKSNewDrawBubbleView()
...
@implementation SKSNewDrawBubbleView
...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat smallCircleRadius = 20.0f;//正常的小圆的半径
    CGFloat bubbleTurnCornerAngleRadius = 1.0f;//气泡视图的尖角的半径

    //气泡尖角中转角中的大圆
    CGFloat bubbleAngleMoreAngleRadius = 33;//气泡尖角中的转角的大圆
